...
function MyHelpVim()
	:40vs $HOME/.vim/help/vimhelp.vim
endfunction

function MyHelpFiles()
	if (&ft == 'tex')
		:40vs $HOME/.vim/help/texhelp.tex
	elseif (&ft == 'vim')
		:40vs $HOME/.vim/help/vimhelp.vim
	elseif (&ft == 'c')
		:40vs $HOME/.vim/help/chelp.c
	endif
endfunction
...
au BufNewFile *.tex 0r $HOME/.vim/templates/template.tex
au BufNewFile *.py 0r $HOME/.vim/templates/template.py
au BufNewFile *.c 0r $HOME/.vim/templates/template.c
